...
if($queried_object->post_type == 'post'){
  $current_cat_id = get_cat_ID($parent_item->title);
  $post_top_category = get_post_top_parent_category($queried_object->ID);
  if ($current_cat_id == $post_top_category->cat_ID) {
    $classes[] = 'current-menu-ancestor';
    $menu_items[$key]->current_item_ancestor = true;
  }
  $post_categories = get_post_parent_categories($queried_object->ID);
