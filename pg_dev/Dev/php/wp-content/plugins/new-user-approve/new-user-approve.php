...
class pw_new_user_approve {
    ...
    public function approve_user( $user_id ) {
        ...
        // format the message
        $message  = sprintf( __( 'You have been approved to access %s', 'new-user-approve' ), network_home_url( '/' ) ) . "\r\n";
        $message .= sprintf( __( 'Username: %s', 'new-user-approve' ), $user_login ) . "\r\n";
        if ( ! $bypass_password_reset ) {
            $message .= sprintf( __( 'Temporary password: %s', 'new-user-approve' ), $new_pass ) . "\r\n\r\n";
        }
        $message .= sprintf(__( 'You can change your password by clicking »change password« under login form at %s', 'new-user-approve' ), network_home_url( '/' )) . "\r\n\r\n";
    ...
    public function deny_user( $user_id ) {
        ...
        // format the message
        $message = __( 'Your registration request has been canceled by administrator.', 'new-user-approve' ) . "\r\n";
        $message .= sprintf( __( 'If this is an error please contact to %s', 'new-user-approve' ), get_option( 'admin_email' ) ) . "\r\n\n";
        $message .= __( '-- best regards' ) . "\r\n";
