...
jQuery(document).ready( function($) {
  ...
  $('form.lwa-form, form.lwa-remember, div.lwa-register form').submit(function(event){
    ...
    request
      ...
      .fail(function(jqXHR, textStatus, errorThrown) {
        lwaAjax({'result': 'unknown'}, statusElement);
      })
  ...
  function lwaAjax(data, statusElement) {
    ...
    if (data.result === true) {
      //Login Successful
      $('.lwa-username, .lwa-email , .submit, #user_login, #user_email, #wp-submit').remove();
      ...
      statusElement.attr('class','lwa-status lwa-status-invalid').html('Wystąpił błąd przy połączeniu. Spróbuj ponownie, lub skontaktuj się ze swoim guru.'); //modify status content
    }
  }
